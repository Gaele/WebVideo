...
<input type="button" name="Acheter" value="Acheter" onclick="self.location.href='Acheter.html'" style="background-color: cyan" style="color: purple; font-weight:bold" onclick>
<input type="button" name="Louer" value="Louer" onclick="self.location.href='Louer.html'" style="background-color: red" style="color: purple; font-weight:bold" onclick>
